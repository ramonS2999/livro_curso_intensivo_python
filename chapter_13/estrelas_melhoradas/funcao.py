...
def get_number_estrelas_x(configuracao, estrela_largura):
    ...
    numero_randomico = randint(-10,10)
    espaco_disponivel_x = configuracao.tela_largura - 2 * estrela_largura * numero_randomico
    number_estrelas_x = int(espaco_disponivel_x / (2 * estrela_largura))
