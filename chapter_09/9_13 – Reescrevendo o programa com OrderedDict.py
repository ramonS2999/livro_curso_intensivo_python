...
# --- Criamos uma instância da classe OrderedDict e a armazenamos em favorite_languages. ---
glossario = OrderedDict()

# --- Adicionamos cada nome e linguagem em favorite_languages, um de cada vez. ---
glossario['paradigima'] = '''\n1. um exemplo que serve como modelo; padrão. \n
...
glossario['Orientação a objeto'] = '''né um conceito que esta relacionado com a ideia de classificar, organizar e abstrair \n
...
# --- Percorremos glossario com um laço ---
for palavra, siginificado in glossario.items():
    # --- sempre teremos as respostas na ordem em que os itens foram adicionados. ---
